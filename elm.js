			...
			A2(
						...
						A2(
							...
							function (_v0) {
								...
								return A2(
									...
									_List_fromArray(
										[
											A2($elm$html$Html$Attributes$style, 'font-weight', x)
										]),
									_List_fromArray(
										[
				...
				_List_fromArray(
					[
						_List_fromArray(
						[
							_Utils_Tuple2('500', 'Mathematics'),
							_Utils_Tuple2('200', '&')
						]),
						_List_fromArray(
						[
							_Utils_Tuple2('500', 'Computer Science')
						]),
						_List_fromArray(
						[
							_Utils_Tuple2('300', 'student')
						])
					])))
		]));
